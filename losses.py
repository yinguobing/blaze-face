...
These functions are copied from Keras official example.
"""
...
class BlazeLoss(tf.losses.Loss):
    """Wrapper to combine both the losses"""

    def __init__(self, num_classes=2, alpha=0.25, gamma=2.0, delta=1.0):
        super(BlazeLoss, self).__init__(
...
#             input_tensor=tf.cast(tf.greater(cls_labels, 0), tf.float32))
